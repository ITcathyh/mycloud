                        ...
                        <div class="box-body non-padding text_small border_1">
                            <table class="table">
                                <tr>
                                    ...
                                    <th class="text_small border_2">Type</th>
                                    <th class="text_small border_2">Tag</th>
                                    <th class="text_small border_2">Downloads</th>
                                </tr>
                                <%
                                    ...
                                    if (userfiles == null || userfiles.size() == 0) {
                                        ...
                                        for (int i = 0, len = userfiles.size(); i < len; i++) {
                                            ...
                                            out.println("<tr  class=\"text_small border_1\" onclick=\"javascrtpt:window.location.href='/admin/file?fileid=" + file.getId() + "'\">");
